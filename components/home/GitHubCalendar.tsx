        ...
        >
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between mb-8">
            ...
            <a
              ...
              className="flex items-center gap-1.5 px-4 py-2 rounded-full border border-border text-text-muted text-sm hover:border-brand-blue hover:text-brand-blue transition-colors"
            >

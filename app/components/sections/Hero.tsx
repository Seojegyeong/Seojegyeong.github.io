...
const keywords = ["Component-driven UI", "State & Data Flow", "Responsive UX"];
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-start">
              ...
              <div className="space-y-2.5">
                ...
                <div className="flex items-center justify-between gap-4">
                  <div className="space-y-0.5">
                    <span className="text-sm font-medium text-slate-600 block">{degreeText}</span>
        ...
        <div className="hidden md:flex md:col-span-4 justify-end">
          <div className="relative w-full max-w-[260px]">
            <div className="relative aspect-4/5 overflow-hidden rounded-3xl border-2 border-slate-100 shadow-lg">
              <Image
                src="/profile.jpg"
                alt={profile.name}
                fill
            ...
            <div className="mt-3 flex items-center justify-center gap-1.5 text-sm font-medium text-slate-500">
